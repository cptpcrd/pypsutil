...
class Process:  # pylint: disable=too-many-instance-attributes
    ...
    if hasattr(_psimpl, "proc_children"):
            ...
            if recursive:
                ...
                while True:
                    ...
                    for parent in search_parents:
                        for child_pid in _psimpl.proc_children(parent):
                ...
                for pid in _psimpl.proc_children(self):
                    try:
